...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        protected virtual void GatherInput() {
            ...
            _running = _frameInput.Run ? true : false;
        ...
        protected virtual void HandleHorizontal() {
            ...
            // Running
            if (_stats.AllowRun && _running)
			{
                _speed.x = Mathf.Clamp(_speed.x, -_stats.MaxRunSpeed, _stats.MaxRunSpeed);

            }
            // No run
            else
			{
                if (_grounded || !_stats.AllowRun || !_running)
				{
